 ...
 */
<<<<<<<< HEAD:migrations/Version20251218174858.php
final class Version20251218174858 extends AbstractMigration
========
final class Version20251212144005 extends AbstractMigration
>>>>>>>> Hamza:migrations/Version20251212144005.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artiste (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, display_name VARCHAR(180) NOT NULL, biography LONGTEXT DEFAULT NULL, specialty VARCHAR(120) DEFAULT NULL, social_links JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', website VARCHAR(255) DEFAULT NULL, avatar_path VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, is_featured TINYINT(1) DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', views_count INT DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_9C07354FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commission (id INT AUTO_INCREMENT NOT NULL, oeuvre_id INT NOT NULL, artiste_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, prix_final DOUBLE PRECISION NOT NULL, date_creation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1C65015888194DE8 (oeuvre_id), INDEX IDX_1C65015821D25844 (artiste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
<<<<<<<< HEAD:migrations/Version20251218174858.php
        $this->addSql('CREATE TABLE oeuvre (id INT AUTO_INCREMENT NOT NULL, artiste_id INT NOT NULL, title VARCHAR(180) NOT NULL, slug VARCHAR(180) NOT NULL, description LONGTEXT NOT NULL, image_path VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, status VARCHAR(40) NOT NULL, is_commentable TINYINT(1) DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', published_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', views_count INT DEFAULT 0 NOT NULL, votes_count INT DEFAULT 0 NOT NULL, favorites_count INT DEFAULT 0 NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, UNIQUE INDEX UNIQ_35FE2EFE989D9B62 (slug), INDEX IDX_35FE2EFE21D25844 (artiste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
...
========
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, echere_id INT NOT NULL, user_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, date_offre DATETIME NOT NULL, INDEX IDX_AF86866F581343CA (echere_id), INDEX IDX_AF86866FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, dateparticipation DATETIME NOT NULL, statut VARCHAR(20) NOT NULL, votepublic INT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
>>>>>>>> Hamza:migrations/Version20251212144005.php
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, reported_user_id INT NOT NULL, reported_by_id INT NOT NULL, reason LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_C42F7784E7566E (reported_user_id), INDEX IDX_C42F778471CE806 (reported_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) DEFAULT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, role VARCHAR(30) NOT NULL, date_inscription DATETIME NOT NULL, google_id VARCHAR(255) DEFAULT NULL, reset_code VARCHAR(255) DEFAULT NULL, reset_code_expires_at DATETIME DEFAULT NULL, verification_code VARCHAR(6) DEFAULT NULL, verification_code_expires_at DATETIME DEFAULT NULL, is_verified TINYINT(1) DEFAULT 0 NOT NULL, is_active TINYINT(1) NOT NULL, avatar_url VARCHAR(255) DEFAULT NULL, telephone VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), UNIQUE INDEX UNIQ_1D1C63B376F5C865 (google_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commission ADD CONSTRAINT FK_1C65015888194DE8 FOREIGN KEY (oeuvre_id) REFERENCES oeuvre (id)');
        $this->addSql('ALTER TABLE commission ADD CONSTRAINT FK_1C65015821D25844 FOREIGN KEY (artiste_id) REFERENCES artiste (id)');
...
========
        $this->addSql('ALTER TABLE offre ADD CONSTRAINT FK_AF86866FA76ED395 FOREIGN KEY (user_id) REFERENCES utilisateur (id)');
>>>>>>>> Hamza:migrations/Version20251212144005.php
        ...
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784E7566E FOREIGN KEY (reported_user_id) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commission DROP FOREIGN KEY FK_1C65015888194DE8');
        $this->addSql('ALTER TABLE commission DROP FOREIGN KEY FK_1C65015821D25844');
