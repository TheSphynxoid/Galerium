 ...
 */
final class Version20251207111400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, oeuvre_id INT NOT NULL, artiste_id INT NOT NULL, concours_title VARCHAR(180) DEFAULT NULL, status VARCHAR(20) NOT NULL, submitted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', result_position INT DEFAULT NULL, jury_notes LONGTEXT DEFAULT NULL, score NUMERIC(5, 2) DEFAULT NULL, notified_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_AB55E24F88194DE8 (oeuvre_id), INDEX IDX_AB55E24F21D25844 (artiste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
