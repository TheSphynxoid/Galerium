 ...
 */
final class Version20251211143421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, discussion_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, oeuvre_id INT DEFAULT NULL, contenu LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, note INT DEFAULT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_67F068BC1ADED311 (discussion_id), INDEX IDX_67F068BC7E3C61F9 (owner_id), INDEX IDX_67F068BC88194DE8 (oeuvre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE discussion (id INT AUTO_INCREMENT NOT NULL, forum_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, date_creation DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_C0B9F90F29CCBAD0 (forum_id), INDEX IDX_C0B9F90F7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE favori (id INT AUTO_INCREMENT NOT NULL, oeuvre_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, date_ajout DATETIME NOT NULL, INDEX IDX_EF85A2CC88194DE8 (oeuvre_id), INDEX IDX_EF85A2CCFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, password VARCHAR(255) DEFAULT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, role VARCHAR(30) NOT NULL, date_inscription DATETIME NOT NULL, google_id VARCHAR(255) DEFAULT NULL, avatar_url VARCHAR(500) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), UNIQUE INDEX UNIQ_1D1C63B376F5C865 (google_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
